...
exports.googleCalendarApi = {
    ...
    getAccessToken: async (user) => {
        const oauth2Client = new googleapis_1.google.auth.OAuth2(process.env.GOOGLE_CLIENT_ID, process.env.GOOGLE_CLIENT_SECRET, `${process.env.SERVER_URL}/auth/callback`);
...
//# sourceMappingURL=googleCalendarApi.js.map